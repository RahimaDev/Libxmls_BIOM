...
int main(int argc, char **argv)
{
    ...
    if(argc < 6)
    {
        cout << "Usage: " << argv[0] << "  sbet acc laser_calib.xml ept_folder output [tri_threshold=0.5 (int)start_time (int)end_time pivot_E=-1 pivot_N=-1 pivot_H=0 add_rgb=0]" << endl;
